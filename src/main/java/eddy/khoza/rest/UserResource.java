package eddy.khoza.rest;

import eddy.khoza.domain.User;
import eddy.khoza.model.UserDTO;
import eddy.khoza.model.UserLoginRequest;
import eddy.khoza.service.UserService;
...
public class UserResource {
    ...
    public ResponseEntity<Long> registerUser(@RequestBody @Valid final UserDTO userDTO) {
